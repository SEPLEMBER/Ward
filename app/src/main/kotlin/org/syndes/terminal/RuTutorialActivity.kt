...
==E: Settings, Shortcuts & Apps shortcuts==
  acc                  - открыть настройки аккаунта
  ...
  browser [url]        - открыть браузер с необязательным URL
  ...
  sms [number] [text]  - открыть SMS-приложение с необязательным номером/текстом
